...
function draw() {
  ...
  let vector_in_vector_out = [
    ['add()', 'add'],
    ['sub()', 'sub'],
    ['cross() [results end up in the 3rd dimension]', 'cross'],
  ];

  //let vector_in_scalar_out = [
  //  ['dot()', 'dot'],
  //  ['dist()', 'dist'],
  //  ['angleBetween()', 'angleBetween'],
  //];

  //let scalar_in_vector_out = [
  //  ['mult()', 'mult'],
  //  ['div()', 'div'],
  //  ['rotate()', 'rotate'],
  //];

  //let scalar_in_scalar_out = [
  //];

  //let nothing_in_scalar_out = [
  //  ['mag()', 'mag'],
  //  ['magSq()', 'magSq'],
  //  ['heading()', 'heading'],
  //];
...
function draw_vector_effect(title, effect, offset, input_vector) {
  ...
  offset.y += 40;
  let primary_vector_offset = p5.Vector.add(primary_vector, offset);
  stroke(255, 0, 0);
  line(offset.x, offset.y, primary_vector_offset.x, primary_vector_offset.y);

  let secondary_vector_offset = p5.Vector.add(secondary_vector, offset);
  stroke(0, 255, 0);
